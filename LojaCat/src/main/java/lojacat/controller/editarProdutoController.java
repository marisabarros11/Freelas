...
@MultipartConfig
/**
 * Servlet implementation class editarProdutoController
 */
            ...
            if (codigo != null && !codigo.isEmpty() &&
                ...
                try {
                    ...
                    if (valor.matches("^\\d+\\.\\d{2}$")) {
            			...
            			boolean f = dao.editarProduto(produto);

                        if (f) {
                            mensagem = "Produto atualizado com sucesso";
                            // substituir pelo caminho do projeto no computador, ou do local onde o site será hospedado.
                            String uploadPath ="C:/Users/maris/eclipse-workspace/LojaCat/WebContent/img/produtos/"+nomeImagem;
